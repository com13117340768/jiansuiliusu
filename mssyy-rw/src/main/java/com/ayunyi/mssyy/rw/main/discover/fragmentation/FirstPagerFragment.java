 ...
 */
public class FirstPagerFragment extends RedWineFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView(View view) {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position, View view, RecyclerView.ViewHolder vh) {
               ...
               getParentDelegate().getSupportDelegate().start(DetailFragment.newInstance(mAdapter.getItem(position).getTitle()));
            }
        });
