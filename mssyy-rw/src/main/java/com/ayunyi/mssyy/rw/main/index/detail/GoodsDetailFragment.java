...
import com.yy.core.ui.Banner.HolderCreator;
import com.yy.core.util.animation.BezierAnimation;
import com.yy.core.util.animation.BezierUtil;
 ...
 */
public class GoodsDetailFragment extends RedWineFragment implements
    ...
    public static GoodsDetailFragment create(int goodsId) {
        ...
        GoodsDetailFragment delegate = new GoodsDetailFragment();
