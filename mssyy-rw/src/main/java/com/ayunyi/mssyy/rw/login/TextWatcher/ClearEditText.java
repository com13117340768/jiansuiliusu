package com.ayunyi.mssyy.rw.login.TextWatcher;
...
public class ClearEditText extends TextInputEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
     ...
     //   if (mClearDrawable == null) {
        ...
        mClearDrawable = getResources().getDrawable(R.drawable.clera);
        mClearDrawable =zoomDrawable(mClearDrawable,150,150);
     //   }
